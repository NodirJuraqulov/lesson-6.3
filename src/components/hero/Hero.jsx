...
const Hero = ({title, main_title, desc, more, image, color, bg_color, collection}) => {
  return (
        ...
        <div className='text-center flex flex-col justify-between'>
            ...
            <div className='text-center'>
                ...
                <div className='flex items-center gap-8 justify-center'>
                    ...
                    <button style={{background: color, color: bg_color}} className='btn w-30 h-12 rounded-3xl font-medium'>Buy now</button>
                </div>
            </div>
        </div>
    </div>
